    ...
    with Pool(2) as p:
        ...
        def run_selenium1(jobTitle, skill1, undesired, pageNumber, resumeContent):
            ...
            def get_links(i, resumeContent):
                ...
                for links, titles, companies, summaries, descriptions in zip(Final_Links, Final_Titles, Final_Company, shortened_summary, Final_Description):
        ...
        def openAIGetRelevantJobTitles(resumeContent):
            ...
            if ExperienceLevel is not None:
                ...
                progressText.markdown( f"<h6 style='text-align: center; font-family: Sans-Serif;font-weight: lighter;'>Now just apply! Good Luck :)</h6>",unsafe_allow_html=True)
