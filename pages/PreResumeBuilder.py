...
st.set_page_config(page_title="19th Street | Resume Builder", layout="wide", page_icon="⓵⓽", initial_sidebar_state="collapsed")
...
#root > div:nth-child(1) > div.withScreencast > div > div > div > section.main.css-k1vhr4.egzxvld5 > div.block-container.css-k1ih3n.egzxvld4 > div:nth-child(1) > div > div:nth-child(5){                   margin-top:-90px;
                   min-width:100%;
                   margin-left:-90px;
                   position:fixed;
                   z-index:2;
        ...
        col1header, col2header, col3header = st.columns([2, 0.45, 2])
