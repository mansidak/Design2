...
options = st.multiselect('Filter through company', [item[5] for item in st.session_state['FinalResults']], [])

st.write('You selected:', [item[5] for item in st.session_state['FinalResults']])
