...
"""
    ...
    if ResumePDF is not None:
        ...
        Name, newJobtitlesDuplicate, newSkillsDuplicate, softSkillsDuplicate, OldSkillsBulletDuplicate = openAIGetRelevantJobTitles(resumeContent)
        ...
        locationpreference = holder4.selectbox(
            'Enter Location Preference', (" New York, New York", " Los Angeles, California", " Chicago, Illinois",
" Houston, Texas",
" Phoenix, Arizona",
