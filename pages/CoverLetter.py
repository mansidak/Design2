...
st.write(f"Now you can apply directly to the jobs you've found, or create custom cover letters to give yourself a competitive edge.", unsafe_allow_html=True)
