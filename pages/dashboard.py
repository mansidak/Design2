    ...
    def main(user: object):
        ...
        with colResume2:
            ...
            if FirebaseResumeContent:
                st.markdown(f"<h6 style='text-align:center; font-weight:lighter;color:black'>Resume on file:<span style='background: -webkit-gradient(linear,left top,right bottom,from(#34C800), to(#FE0000));-webkit-background-clip:text;-webkit-text-fill-color: transparent;'>&check;</span> </h6>",
                            unsafe_allow_html=True)
